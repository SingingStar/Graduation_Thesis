...
def read_lhe(InputFileList):
  ...
  for InputFile in InputFileList:
      ...
      for event in lhe:
          ...
          if InputFile == InputFile_Inclusive:
              ...
              h_TTEta1.Fill(Eta1)
              h_TTEta2.Fill(Eta2)
              h_TTEta4l.Fill(Eta4l)
          elif InputFile == InputFile_TL:
              h_TLEta1.Fill(Eta1)
              h_TLEta2.Fill(Eta2)
              h_TLEta4l.Fill(Eta4l)
          elif InputFile == InputFile_LL:
              h_LLEta1.Fill(Eta1)
              h_LLEta2.Fill(Eta2)
              h_LLEta4l.Fill(Eta4l)
  ...
  tfout = R.TFile("KinematicQuantity_v1.root", "RECREATE")
  tfout.cd()
