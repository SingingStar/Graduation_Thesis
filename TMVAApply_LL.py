...
def TMVAApply(InputFile):
  ...
  InputFile = R.TFile.Open("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v4_Output/LLTree.root")

  data = InputFile.Get("LLTree")
  ...
  h_LL = R.TH1F("h_LL", "h_LL", 40, -1, 1)
  for i in range(0, data.GetEntries()):
      data.GetEntry(i)
      h_LL.Fill(reader.EvaluateMVA("BDT Method"))

  tfout = R.TFile("h_LL.root", "RECREATE")
  tfout.cd()
...
if __name__ == "__main__":
  ...
  InputFile = R.TFile("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v5_Output/LLTree.root")
