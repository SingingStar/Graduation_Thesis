...
def read_lhe(input_file):
  ...
  """
  # define htitle = "double_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_lep_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_lep_pid = R.TH1F("double_Pt_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_lep_pid.SetTitle("double_Pt_lep_pid;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system without distinguishing the final states and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_lep"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_lep = R.TH1F("double_Pt_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_lep.SetTitle("double_Pt_lep;double_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons without distinguishing the final states and using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_Pt_lep_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_lep_pid = R.TH1F("closer_Zmass_Pt_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_lep_pid.SetTitle("closer_Zmass_Pt_lep_pid;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons without distinguishing the final states and using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_Pt_lep_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_lep_pid = R.TH1F("further_Zmass_Pt_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_lep_pid.SetTitle("further_Zmass_Pt_lep_pid;futher_Zmass_Pt/Gev;count")
  ...
  # define htitle = "closer_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F
  # "lep" means "lepton"
  htitle = "closer_Zmass_Pt_lep"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_lep = R.TH1F("closer_Zmass_Pt_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_lep.SetTitle("closer_Zmass_Pt_lep;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons without distinguishing the final states
  """
  # define htitle = "further_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_lep"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_lep = R.TH1F("further_Zmass_Pt_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_lep.SetTitle("further_Zmass_Pt_lep;further_Zmass_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 4 electrons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_fe_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_fe_pid = R.TH1F("double_Pt_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_fe_pid.SetTitle("double_Pt_fe_pid;double_Pt/Gev;count")
  ...
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_fe = R.TH1F("double_Pt_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_fe.SetTitle("double_Pt_fe;double_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 electrons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_Pt_fe_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_fe_pid = R.TH1F("closer_Zmass_Pt_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_fe_pid.SetTitle("closer_Zmass_Pt_fe_pid;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 electrons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_Pt_fe_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_fe_pid = R.TH1F("further_Zmass_Pt_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_fe_pid.SetTitle("further_Zmass_Pt_fe_pid;futher_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 electrons
  """
  # define htitle = "closer_Zmass_fe", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_fe"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_fe = R.TH1F("closer_Zmass_Pt_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_fe.SetTitle("closer_Zmass_Pt_fe;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 electrons
  """
  # define htitle = "further_Zmass_fe", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_fe"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_fe = R.TH1F("further_Zmass_Pt_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_fe.SetTitle("further_Zmass_Pt_fe;further_Zmass_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 4 muons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_fmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_fmu_pid = R.TH1F("double_Pt_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_fmu_pid.SetTitle("double_Pt_fmu_pid;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states has 4 muons, and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_fmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_fmu = R.TH1F("double_Pt_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_fmu.SetTitle("double_Pt_fmu;double_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_Pt_fmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_fmu_pid = R.TH1F("closer_Zmass_Pt_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_fmu_pid.SetTitle("closer_Zmass_Pt_fmu_pid;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_Pt_fmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_fmu_pid = R.TH1F("further_Zmass_Pt_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_fmu_pid.SetTitle("further_Zmass_Pt_fmu_pid;futher_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 muons
  """
  # define htitle = "closer_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_fmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_fmu = R.TH1F("closer_Zmass_Pt_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_fmu.SetTitle("closer_Zmass_Pt_fmu;closer_Zmass_Pt/Gev;count")
  ...
  """
  # define htitle = "further_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_fmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_fmu = R.TH1F("further_Zmass_Pt_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_fmu.SetTitle("further_Zmass_Pt_fmu;further_Zmass_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 2 eletrons and 2 muons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_tetmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_tetmu_pid = R.TH1F("double_Pt_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_tetmu_pid.SetTitle("double_Pt_tetmu_pid;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states has 2 eletrons and 2 muons, and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_tetmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_tetmu = R.TH1F("double_Pt_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_tetmu.SetTitle("double_Pt_tetmu;double_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 2 electrons and 2 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_Pt_tetmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_tetmu_pid = R.TH1F("closer_Zmass_Pt_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_tetmu_pid.SetTitle("closer_Zmass_Pt_tetmu_pid;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 2 electrons and 2 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_Pt_tetmu_pid"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_tetmu_pid = R.TH1F("further_Zmass_Pt_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_tetmu_pid.SetTitle("further_Zmass_Pt_tetmu_pid;futher_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 2 electrons and 2 muons
  """
  # define htitle = "closer_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_tetmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_tetmu = R.TH1F("closer_Zmass_Pt_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_tetmu.SetTitle("closer_Zmass_Pt_tetmu;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 2 electrons and 2 muons
  """
  # define htitle = "further_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_tetmu"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_tetmu = R.TH1F("further_Zmass_Pt_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_tetmu.SetTitle("further_Zmass_Pt_tetmu;further_Zmass_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state is eemumu,  using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "double_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_eemumu_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_eemumu_Z = R.TH1F("double_Pt_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_eemumu_Z.SetTitle("double_Pt_eemumu_Z;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states is eemumu
  """
  # define htitle = "double_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_eemumu"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_eemumu = R.TH1F("double_Pt_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_eemumu.SetTitle("double_Pt_eemumu;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state is mumuee,  using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "double_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_mumuee_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_mumuee_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_mumuee_Z = R.TH1F("double_Pt_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_mumuee_Z.SetTitle("double_Pt_mumuee_Z;double_Pt/Gev;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states is mumuee
  """
  # define htitle = "double_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_Pt_mumuee"
  nbins, xmin, xmax = 100, 0, 1000
  # "double_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_Pt_mumuee = R.TH1F("double_Pt_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_Pt_mumuee.SetTitle("double_Pt_mumuee;double_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is eemumu
  """
  # define htitle = "closer_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_eemumu"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_eemumu = R.TH1F("closer_Zmass_Pt_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_eemumu.SetTitle("closer_Zmass_Pt_eemumu;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is eemumu
  """
  # define htitle = "further_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_eemumu"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_eemumu = R.TH1F("further_Zmass_Pt_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_eemumu.SetTitle("further_Zmass_Pt_eemumu;further_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is mumuee
  """
  # define htitle = "closer_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_mumuee"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_mumuee = R.TH1F("closer_Zmass_Pt_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_mumuee.SetTitle("closer_Zmass_Pt_mumuee;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is mumuee
  """
  # define htitle = "further_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_mumuee"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_mumuee = R.TH1F("further_Zmass_Pt_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_mumuee.SetTitle("further_Zmass_Pt_mumuee;further_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is eemumu, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "closer_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_eemumu_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_eemumu_Z = R.TH1F("closer_Zmass_Pt_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_eemumu_Z.SetTitle("closer_Zmass_Pt_eemumu_Z;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is eemumu, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "further_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_eemumu_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_eemumu_Z = R.TH1F("further_Zmass_Pt_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_eemumu_Z.SetTitle("further_Zmass_Pt_eemumu_Z;further_Zmass_Pt/Gev;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is mumuee, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "closer_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_Pt_mumuee_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "closer_Zmass_mumuee_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_Pt_mumuee_Z = R.TH1F("closer_Zmass_Pt_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_Pt_mumuee_Z.SetTitle("closer_Zmass_Pt_mumuee_Z;closer_Zmass_Pt/Gev;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is mumuee, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "further_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_Pt_mumuee_Z"
  nbins, xmin, xmax = 100, 0, 1000
  # "further_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_Pt_mumuee_Z = R.TH1F("further_Zmass_Pt_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_Pt_mumuee_Z.SetTitle("further_Zmass_Pt_mumuee_Z;further_Zmass_Pt/Gev;count")
  ...
  """
  # define htitle = "double_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_lep_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_lep_pid = R.TH1F("double_eta_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_lep_pid.SetTitle("double_eta_lep_pid;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system without distinguishing the final states and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_lep"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_lep = R.TH1F("double_eta_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_lep.SetTitle("double_eta_lep;double_eta;count")

  """
  histogram of the closer invariant mass of Z bosons without distinguishing the final states and using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_eta_lep_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_lep_pid = R.TH1F("closer_Zmass_eta_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_lep_pid.SetTitle("closer_Zmass_eta_lep_pid;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons without distinguishing the final states and using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_lep_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_eta_lep_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_lep_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_lep_pid = R.TH1F("further_Zmass_eta_lep_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_lep_pid.SetTitle("further_Zmass_eta_lep_pid;futher_Zmass_eta;count")
  ...
  # define htitle = "closer_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F
  # "lep" means "lepton"
  htitle = "closer_Zmass_eta_lep"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_lep = R.TH1F("closer_Zmass_eta_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_lep.SetTitle("closer_Zmass_eta_lep;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons without distinguishing the final states
  """
  # define htitle = "further_Zmass_lep", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_lep"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_lep" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_lep = R.TH1F("further_Zmass_eta_lep", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_lep.SetTitle("further_Zmass_eta_lep;further_Zmass_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 4 electrons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_fe_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_fe_pid = R.TH1F("double_eta_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_fe_pid.SetTitle("double_eta_fe_pid;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states has 4 electrons, and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_fe", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_fe"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_fe = R.TH1F("double_eta_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_fe.SetTitle("double_eta_fe;double_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 electrons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_eta_fe_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_fe_pid = R.TH1F("closer_Zmass_eta_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_fe_pid.SetTitle("closer_Zmass_eta_fe_pid;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 electrons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_fe_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_eta_fe_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_fe_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_fe_pid = R.TH1F("further_Zmass_eta_fe_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_fe_pid.SetTitle("further_Zmass_eta_fe_pid;futher_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 electrons
  """
  # define htitle = "closer_Zmass_fe", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_fe"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_fe = R.TH1F("closer_Zmass_eta_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_fe.SetTitle("closer_Zmass_eta_fe;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 electrons
  """
  # define htitle = "further_Zmass_fe", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_fe"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_fe" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_fe = R.TH1F("further_Zmass_eta_fe", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_fe.SetTitle("further_Zmass_eta_fe;further_Zmass_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 4 muons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_fmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_fmu_pid = R.TH1F("double_eta_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_fmu_pid.SetTitle("double_eta_fmu_pid;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states has 4 muons, and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_fmu"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_fmu = R.TH1F("double_eta_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_fmu.SetTitle("double_eta_fmu;double_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_eta_fmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_fmu_pid = R.TH1F("closer_Zmass_eta_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_fmu_pid.SetTitle("closer_Zmass_eta_fmu_pid;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 4 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_fmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_eta_fmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_fmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_fmu_pid = R.TH1F("further_Zmass_eta_fmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_fmu_pid.SetTitle("further_Zmass_eta_fmu_pid;futher_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 4 muons
  """
  # define htitle = "closer_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_fmu"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_fmu = R.TH1F("closer_Zmass_eta_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_fmu.SetTitle("closer_Zmass_eta_fmu;closer_Zmass_eta;count")
  ...
  """
  # define htitle = "further_Zmass_fmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_fmu"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_fmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_fmu = R.TH1F("further_Zmass_eta_fmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_fmu.SetTitle("further_Zmass_eta_fmu;further_Zmass_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state has 2 eletrons and 2 muons, and using particleID to distinguish the Z boson
  """
  # define htitle = "double_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_tetmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_tetmu_pid = R.TH1F("double_eta_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_tetmu_pid.SetTitle("double_eta_tetmu_pid;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states has 2 eletrons and 2 muons, and using 4 leptons to rebuild the double Z mass directly
  """
  # define htitle = "double_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_tetmu"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_tetmu = R.TH1F("double_eta_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_tetmu.SetTitle("double_eta_tetmu;double_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 2 electrons and 2 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "closer_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "closer_Zmass_eta_tetmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_tetmu_pid = R.TH1F("closer_Zmass_eta_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_tetmu_pid.SetTitle("closer_Zmass_eta_tetmu_pid;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 2 electrons and 2 muons, using particleID to distinguish the Z boson
  """
  # define htitle = "further_Zmass_tetmu_pid", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "further_Zmass_eta_tetmu_pid"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_tetmu_pid" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_tetmu_pid = R.TH1F("further_Zmass_eta_tetmu_pid", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_tetmu_pid.SetTitle("further_Zmass_eta_tetmu_pid;futher_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state has 2 electrons and 2 muons
  """
  # define htitle = "closer_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_tetmu"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_tetmu = R.TH1F("closer_Zmass_eta_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_tetmu.SetTitle("closer_Zmass_eta_tetmu;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state has 2 electrons and 2 muons
  """
  # define htitle = "further_Zmass_tetmu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_tetmu"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_tetmu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_tetmu = R.TH1F("further_Zmass_eta_tetmu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_tetmu.SetTitle("further_Zmass_eta_tetmu;further_Zmass_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state is eemumu,  using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "double_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_eemumu_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_eemumu_Z = R.TH1F("double_eta_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_eemumu_Z.SetTitle("double_eta_eemumu_Z;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states is eemumu
  """
  # define htitle = "double_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_eemumu"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_eemumu = R.TH1F("double_eta_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_eemumu.SetTitle("double_eta_eemumu;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final state is mumuee,  using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "double_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_mumuee_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_mumuee_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_mumuee_Z = R.TH1F("double_eta_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_mumuee_Z.SetTitle("double_eta_mumuee_Z;double_eta;count")

  """
  histogram of the invariant mass of double Z bosons system whose final states is mumuee
  """
  # define htitle = "double_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F, the "pid" in the title means using particleID = 23 to distinguish the Z boson
  htitle = "double_eta_mumuee"
  nbins, xmin, xmax = 100, -10, 10
  # "double_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_double_eta_mumuee = R.TH1F("double_eta_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_double_eta_mumuee.SetTitle("double_eta_mumuee;double_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is eemumu
  """
  # define htitle = "closer_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_eemumu"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_eemumu = R.TH1F("closer_Zmass_eta_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_eemumu.SetTitle("closer_Zmass_eta_eemumu;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is eemumu
  """
  # define htitle = "further_Zmass_eemumu", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_eemumu"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_eemumu" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_eemumu = R.TH1F("further_Zmass_eta_eemumu", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_eemumu.SetTitle("further_Zmass_eta_eemumu;further_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is mumuee
  """
  # define htitle = "closer_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_mumuee"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_mumuee = R.TH1F("closer_Zmass_eta_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_mumuee.SetTitle("closer_Zmass_eta_mumuee;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is mumuee
  """
  # define htitle = "further_Zmass_mumuee", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_mumuee"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_mumuee = R.TH1F("further_Zmass_eta_mumuee", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_mumuee.SetTitle("further_Zmass_eta_mumuee;further_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is eemumu, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "closer_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_eemumu_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_eemumu_Z = R.TH1F("closer_Zmass_eta_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_eemumu_Z.SetTitle("closer_Zmass_eta_eemumu_Z;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is eemumu, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "further_Zmass_eemumu_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_eemumu_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_eemumu_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_eemumu_Z = R.TH1F("further_Zmass_eta_eemumu_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_eemumu_Z.SetTitle("further_Zmass_eta_eemumu_Z;further_Zmass_eta;count")

  """
  histogram of the closer invariant mass of Z bosons whose final state is mumuee, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "closer_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "closer_Zmass_eta_mumuee_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "closer_Zmass_mumuee_Z" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_closer_Zmass_eta_mumuee_Z = R.TH1F("closer_Zmass_eta_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_closer_Zmass_eta_mumuee_Z.SetTitle("closer_Zmass_eta_mumuee_Z;closer_Zmass_eta;count")

  """
  histogram of the further invariant mass of Z bosons whose final state is mumuee, using MOTHUP to distinguish Z boson directly, avoid rebuild the Z mass
  """
  # define htitle = "further_Zmass_mumuee_Z", and use it to fill in the 2ed parameter in the class TH1F
  htitle = "further_Zmass_eta_mumuee_Z"
  nbins, xmin, xmax = 100, -10, 10
  # "further_Zmass_mumuee" represents the name of the histogram, it's different from the title, which is the 2ed parameter in the TH1F
  h_further_Zmass_eta_mumuee_Z = R.TH1F("further_Zmass_eta_mumuee_Z", htitle, nbins, xmin, xmax)
  # set the title of the histogram
  # the first parameter of function SetTitle is the title of the histogram, the 2ed is the name of x, the 3rd is the name of y
  h_further_Zmass_eta_mumuee_Z.SetTitle("further_Zmass_eta_mumuee_Z;further_Zmass_eta;count")
  ...
  for event in lhe:
      ...
      for particle in event:
          if particle.pid == 23:
              ...
              Pt_lep_pid.append(T_lep_pid[lep_count_pid].Pt())
              eta_lep_pid.append(T_lep_pid[lep_count_pid].PseudoRapidity())
      ...
      h_double_Pt_lep_pid.Fill(T_double_Zmass_lep_pid.Pt())
      h_double_eta_lep_pid.Fill(T_double_Zmass_lep_pid.PseudoRapidity())
      ...
      if abs(invariant_mass_lep_pid[0] - Zmass) > abs(invariant_mass_lep_pid[1] - Zmass):
          ...
          h_closer_Zmass_Pt_lep_pid.Fill(Pt_lep_pid[1])
          h_closer_Zmass_eta_lep_pid.Fill(eta_lep_pid[1])
          h_further_Zmass_lep_pid.Fill(invariant_mass_lep_pid[0])
          h_further_Zmass_Pt_lep_pid.Fill(Pt_lep_pid[0])
          h_further_Zmass_eta_lep_pid.Fill(eta_lep_pid[0])
      else:
          h_closer_Zmass_lep_pid.Fill(invariant_mass_lep_pid[0])
          h_closer_Zmass_Pt_lep_pid.Fill(Pt_lep_pid[0])
          h_closer_Zmass_eta_lep_pid.Fill(eta_lep_pid[0])
          h_further_Zmass_lep_pid.Fill(invariant_mass_lep_pid[1])
          h_further_Zmass_Pt_lep_pid.Fill(Pt_lep_pid[1])
          h_further_Zmass_eta_lep_pid.Fill(eta_lep_pid[1])
      ...
      h_double_Pt_lep.Fill(T_double_Zmass_lep.Pt())
      h_double_eta_lep.Fill(T_double_Zmass_lep.PseudoRapidity())
      ...
      if abs(T_sum_lep1.M() - Zmass) > abs(T_sum_lep2.M() - Zmass):
          ...
          h_closer_Zmass_Pt_lep.Fill(T_sum_lep2.Pt())
          h_closer_Zmass_eta_lep.Fill(T_sum_lep2.PseudoRapidity())
          h_further_Zmass_lep.Fill(T_sum_lep1.M())
          h_further_Zmass_Pt_lep.Fill(T_sum_lep1.Pt())
          h_further_Zmass_eta_lep.Fill(T_sum_lep1.PseudoRapidity())
      else:
          h_closer_Zmass_lep.Fill(T_sum_lep1.M())
          h_closer_Zmass_Pt_lep.Fill(T_sum_lep1.Pt())
          h_closer_Zmass_eta_lep.Fill(T_sum_lep1.PseudoRapidity())
          h_further_Zmass_lep.Fill(T_sum_lep2.M())
          h_further_Zmass_Pt_lep.Fill(T_sum_lep2.Pt())
          h_further_Zmass_eta_lep.Fill(T_sum_lep2.PseudoRapidity())
      ...
      if particle_ID == [11, 11, 11, 11]:
          ...
          for particle in event:
              if particle.pid == 23:
                  ...
                  Pt_fe_pid.append(T_fe_pid[fe_count_pid].Pt())
                  eta_fe_pid.append(T_fe_pid[fe_count_pid].PseudoRapidity())
                  T_double_Zmass_fe_pid += T_fe_pid[fe_count_pid]
                  fe_count_pid += 1
          # histogram of the invariant mass of double Z bosons, using pid to distinguish the Z bosons.
          h_double_Zmass_fe_pid.Fill(T_double_Zmass_fe_pid.M())
          h_double_Pt_fe_pid.Fill(T_double_Zmass_fe_pid.Pt())
          h_double_eta_fe_pid.Fill(T_double_Zmass_fe_pid.PseudoRapidity())
          # histogram of the invariant mass of Z bosons, using pid to distinguish the Z bosons.
          if abs(invariant_mass_fe_pid[0] - Zmass) > abs(invariant_mass_fe_pid[1] - Zmass):
              h_closer_Zmass_fe_pid.Fill(invariant_mass_fe_pid[1])
              h_closer_Zmass_Pt_fe_pid.Fill(Pt_fe_pid[1])
              h_closer_Zmass_eta_fe_pid.Fill(eta_fe_pid[1])
              h_further_Zmass_fe_pid.Fill(invariant_mass_fe_pid[0])
              h_further_Zmass_Pt_fe_pid.Fill(Pt_fe_pid[0])
              h_further_Zmass_eta_fe_pid.Fill(eta_fe_pid[0])
          else:
              h_closer_Zmass_fe_pid.Fill(invariant_mass_fe_pid[0])
              h_closer_Zmass_Pt_fe_pid.Fill(Pt_fe_pid[0])
              h_closer_Zmass_eta_fe_pid.Fill(eta_fe_pid[0])
              h_further_Zmass_fe_pid.Fill(invariant_mass_fe_pid[1])
              h_further_Zmass_Pt_fe_pid.Fill(Pt_fe_pid[1])
              h_further_Zmass_eta_fe_pid.Fill(eta_fe_pid[1])
          ...
          h_double_Pt_fe.Fill(T_double_Zmass_fe.Pt())
          h_double_eta_fe.Fill(T_double_Zmass_fe.PseudoRapidity())
          ...
          if abs(T_sum_1st_fe.M() - Zmass) > abs(T_sum_2ed_fe.M() - Zmass):
              ...
              h_closer_Zmass_Pt_fe.Fill(T_sum_2ed_fe.Pt())
              h_closer_Zmass_eta_fe.Fill(T_sum_2ed_fe.PseudoRapidity())
              h_further_Zmass_fe.Fill(T_sum_1st_fe.M())
              h_further_Zmass_Pt_fe.Fill(T_sum_1st_fe.Pt())
              h_further_Zmass_eta_fe.Fill(T_sum_1st_fe.PseudoRapidity())
          else:
              h_closer_Zmass_fe.Fill(T_sum_1st_fe.M())
              h_closer_Zmass_Pt_fe.Fill(T_sum_1st_fe.Pt())
              h_closer_Zmass_eta_fe.Fill(T_sum_1st_fe.PseudoRapidity())
              h_further_Zmass_fe.Fill(T_sum_2ed_fe.M())
              h_further_Zmass_Pt_fe.Fill(T_sum_2ed_fe.Pt())
              h_further_Zmass_eta_fe.Fill(T_sum_2ed_fe.PseudoRapidity())
          fe_count += 1
      ...
      # second type of final states: 4 muons
          ...
          for particle in event:
              if particle.pid == 23:
                  ...
                  Pt_fmu_pid.append(T_fmu_pid[fmu_count_pid].Pt())
                  eta_fmu_pid.append(T_fmu_pid[fmu_count_pid].PseudoRapidity())
                  T_double_Zmass_fmu_pid += T_fmu_pid[fmu_count_pid]
                  fmu_count_pid += 1

          # histogram of the invariant mass of double Z bosons, using pid to distinguish the Z bosons.
          h_double_Zmass_fmu_pid.Fill(T_double_Zmass_fmu_pid.M())
          h_double_Pt_fmu_pid.Fill(T_double_Zmass_fmu_pid.Pt())
          h_double_eta_fmu_pid.Fill(T_double_Zmass_fmu_pid.PseudoRapidity())
          # histogram of the invariant mass of Z bosons, using pid to distinguish the Z bosons.
          if abs(invariant_mass_fmu_pid[0] - Zmass) > abs(invariant_mass_fmu_pid[1] - Zmass):
              ...
              h_closer_Zmass_Pt_fmu_pid.Fill(Pt_fmu_pid[1])
              h_closer_Zmass_eta_fmu_pid.Fill(eta_fmu_pid[1])
              h_further_Zmass_fmu_pid.Fill(invariant_mass_fmu_pid[0])
              h_further_Zmass_Pt_fmu_pid.Fill(Pt_fmu_pid[0])
              h_further_Zmass_eta_fmu_pid.Fill(eta_fmu_pid[0])
          else:
              h_closer_Zmass_fmu_pid.Fill(invariant_mass_fmu_pid[0])
              h_closer_Zmass_Pt_fmu_pid.Fill(Pt_fmu_pid[0])
              h_closer_Zmass_eta_fmu_pid.Fill(eta_fmu_pid[0])
              h_further_Zmass_fmu_pid.Fill(invariant_mass_fmu_pid[1])
              h_further_Zmass_Pt_fmu_pid.Fill(Pt_fmu_pid[1])
              h_further_Zmass_eta_fmu_pid.Fill(eta_fmu_pid[1])
          ...
          h_double_Pt_fmu.Fill(T_double_Zmass_fmu.Pt())
          h_double_eta_fmu.Fill(T_double_Zmass_fmu.PseudoRapidity())
          ...
          if abs(T_sum_1st_fmu.M() - Zmass) > abs(T_sum_2ed_fmu.M() - Zmass):
              ...
              h_closer_Zmass_Pt_fmu.Fill(T_sum_2ed_fmu.Pt())
              h_closer_Zmass_eta_fmu.Fill(T_sum_2ed_fmu.PseudoRapidity())
              h_further_Zmass_fmu.Fill(T_sum_1st_fmu.M())
              h_further_Zmass_Pt_fmu.Fill(T_sum_1st_fmu.Pt())
              h_further_Zmass_eta_fmu.Fill(T_sum_1st_fmu.PseudoRapidity())
          else:
              h_closer_Zmass_fmu.Fill(T_sum_1st_fmu.M())
              h_closer_Zmass_Pt_fmu.Fill(T_sum_1st_fmu.Pt())
              h_closer_Zmass_eta_fmu.Fill(T_sum_1st_fmu.PseudoRapidity())
              h_further_Zmass_fmu.Fill(T_sum_2ed_fmu.M())
              h_further_Zmass_Pt_fmu.Fill(T_sum_2ed_fmu.Pt())
              h_further_Zmass_eta_fmu.Fill(T_sum_2ed_fmu.PseudoRapidity())
          fmu_count += 1
      ...
      # third type of final states: 2 electrons and 2 muons
          ...
          for particle in event:
              if particle.pid == 23:
                  ...
                  Pt_tetmu_pid.append(T_tetmu_pid[tetmu_count_pid].Pt())
                  eta_tetmu_pid.append(T_tetmu_pid[tetmu_count_pid].PseudoRapidity())
                  T_double_Zmass_tetmu_pid += T_tetmu_pid[tetmu_count_pid]
                  tetmu_count_pid += 1

          # histogram of the invariant mass of double Z bosons, using pid to distinguish the Z bosons.
          h_double_Zmass_tetmu_pid.Fill(T_double_Zmass_tetmu_pid.M())
          h_double_Pt_tetmu_pid.Fill(T_double_Zmass_tetmu_pid.Pt())
          h_double_eta_tetmu_pid.Fill(T_double_Zmass_tetmu_pid.PseudoRapidity())
          # histogram of the invariant mass of Z bosons, using pid to distinguish the Z bosons.
          if abs(invariant_mass_tetmu_pid[0] - Zmass) > abs(invariant_mass_tetmu_pid[1] - Zmass):
              ...
              h_closer_Zmass_Pt_tetmu_pid.Fill(Pt_tetmu_pid[1])
              h_closer_Zmass_eta_tetmu_pid.Fill(eta_tetmu_pid[1])
              h_further_Zmass_tetmu_pid.Fill(invariant_mass_tetmu_pid[0])
              h_further_Zmass_Pt_tetmu_pid.Fill(Pt_tetmu_pid[0])
              h_further_Zmass_eta_tetmu_pid.Fill(eta_tetmu_pid[0])
          else:
              h_closer_Zmass_tetmu_pid.Fill(invariant_mass_tetmu_pid[0])
              h_closer_Zmass_Pt_tetmu_pid.Fill(Pt_tetmu_pid[0])
              h_closer_Zmass_eta_tetmu_pid.Fill(eta_tetmu_pid[0])
              h_further_Zmass_tetmu_pid.Fill(invariant_mass_tetmu_pid[1])
              h_further_Zmass_Pt_tetmu_pid.Fill(Pt_tetmu_pid[1])
              h_further_Zmass_eta_tetmu_pid.Fill(eta_tetmu_pid[1])
          ...
          h_double_Pt_tetmu.Fill(T_double_Zmass_tetmu.Pt())
          h_double_eta_tetmu.Fill(T_double_Zmass_tetmu.PseudoRapidity())
          ...
          if abs(T_sum_1st_tetmu.M() - Zmass) > abs(T_sum_2ed_tetmu.M() - Zmass):
              ...
              h_closer_Zmass_Pt_tetmu.Fill(T_sum_2ed_tetmu.Pt())
              h_closer_Zmass_eta_tetmu.Fill(T_sum_2ed_tetmu.PseudoRapidity())
              h_further_Zmass_tetmu.Fill(T_sum_1st_tetmu.M())
              h_further_Zmass_Pt_tetmu.Fill(T_sum_1st_tetmu.Pt())
              h_further_Zmass_eta_tetmu.Fill(T_sum_1st_tetmu.PseudoRapidity())
          else:
              h_closer_Zmass_tetmu.Fill(T_sum_1st_tetmu.M())
              h_closer_Zmass_Pt_tetmu.Fill(T_sum_1st_tetmu.Pt())
              h_closer_Zmass_eta_tetmu.Fill(T_sum_1st_tetmu.PseudoRapidity())
              h_further_Zmass_tetmu.Fill(T_sum_2ed_tetmu.M())
              h_further_Zmass_Pt_tetmu.Fill(T_sum_2ed_tetmu.Pt())
              h_further_Zmass_eta_tetmu.Fill(T_sum_2ed_tetmu.PseudoRapidity())
          tetmu_count += 1
          ...
          if abs(T_sum_muon.M() - Zmass) > abs(T_sum_electron.M() - Zmass):
              ...
              h_closer_Zmass_Pt_eemumu.Fill(T_sum_electron.Pt())
              h_closer_Zmass_eta_eemumu.Fill(T_sum_electron.PseudoRapidity())
              h_further_Zmass_eemumu.Fill(T_sum_muon.M())
              h_further_Zmass_Pt_eemumu.Fill(T_sum_muon.Pt())
              h_further_Zmass_eta_eemumu.Fill(T_sum_muon.PseudoRapidity())

              T_double_Zmass_eemumu = T_sum_electron + T_sum_muon
              h_double_Zmass_eemumu.Fill(T_double_Zmass_eemumu.M())
              h_double_Pt_eemumu.Fill(T_double_Zmass_eemumu.Pt())
              h_double_eta_eemumu.Fill(T_double_Zmass_eemumu.PseudoRapidity())


              eemumu_count += 1
          else:
              h_closer_Zmass_mumuee.Fill(T_sum_muon.M())
              h_closer_Zmass_Pt_mumuee.Fill(T_sum_muon.Pt())
              h_closer_Zmass_eta_mumuee.Fill(T_sum_muon.PseudoRapidity())

              h_further_Zmass_mumuee.Fill(T_sum_electron.M())
              h_further_Zmass_Pt_mumuee.Fill(T_sum_electron.Pt())
              h_further_Zmass_eta_mumuee.Fill(T_sum_electron.PseudoRapidity())
              T_double_Zmass_mumuee = T_sum_electron + T_sum_muon
              h_double_Zmass_mumuee.Fill(T_double_Zmass_mumuee.M())
              h_double_Pt_mumuee.Fill(T_double_Zmass_mumuee.Pt())
              h_double_eta_mumuee.Fill(T_double_Zmass_mumuee.PseudoRapidity())
          ...
          if abs(T_muon_Z.M() - Zmass) > abs(T_electron_Z.M() - Zmass):
              ...
              h_closer_Zmass_Pt_eemumu_Z.Fill(T_electron_Z.Pt())
              h_closer_Zmass_eta_eemumu_Z.Fill(T_electron_Z.PseudoRapidity())

              h_further_Zmass_eemumu_Z.Fill(T_muon_Z.M())
              h_further_Zmass_Pt_eemumu_Z.Fill(T_muon_Z.Pt())
              h_further_Zmass_eta_eemumu_Z.Fill(T_muon_Z.PseudoRapidity())


              T_double_Zmass_eemumu_Z = T_electron_Z + T_muon_Z
              h_double_Zmass_eemumu_Z.Fill(T_double_Zmass_eemumu_Z.M())
              h_double_Pt_eemumu_Z.Fill(T_double_Zmass_eemumu_Z.Pt())
              h_double_eta_eemumu_Z.Fill(T_double_Zmass_eemumu_Z.PseudoRapidity())
          else:
              h_closer_Zmass_mumuee_Z.Fill(T_muon_Z.M())
              h_closer_Zmass_Pt_mumuee_Z.Fill(T_muon_Z.Pt())
              h_closer_Zmass_eta_mumuee_Z.Fill(T_muon_Z.PseudoRapidity())
              h_further_Zmass_mumuee_Z.Fill(T_electron_Z.M())
              h_further_Zmass_Pt_mumuee_Z.Fill(T_electron_Z.Pt())
              h_further_Zmass_eta_mumuee_Z.Fill(T_electron_Z.PseudoRapidity())

              T_double_Zmass_mumuee_Z = T_electron_Z + T_muon_Z
              h_double_Zmass_mumuee_Z.Fill(T_double_Zmass_mumuee_Z.M())
              h_double_Pt_mumuee_Z.Fill(T_double_Zmass_mumuee_Z.Pt())
              h_double_eta_mumuee_Z.Fill(T_double_Zmass_mumuee_Z.PseudoRapidity())
  ...
  tfout = R.TFile("mass_Pt_and_eta_of_Z_bosons.root", "RECREATE")
  tfout.cd()
  ...
  h_double_Pt_lep_pid.Write()
  h_double_Pt_lep.Write()
  h_closer_Zmass_Pt_lep_pid.Write()
  h_further_Zmass_Pt_lep_pid.Write()
  h_closer_Zmass_Pt_lep.Write()
  h_further_Zmass_Pt_lep.Write()
  h_double_Pt_fe_pid.Write()
  h_double_Pt_fe.Write()
  h_closer_Zmass_Pt_fe_pid.Write()
  h_further_Zmass_Pt_fe_pid.Write()
  h_closer_Zmass_Pt_fe.Write()
  h_further_Zmass_Pt_fe.Write()
  h_double_Pt_fmu_pid.Write()
  h_double_Pt_fmu.Write()
  h_closer_Zmass_Pt_fmu_pid.Write()
  h_further_Zmass_Pt_fmu_pid.Write()
  h_closer_Zmass_Pt_fmu.Write()
  h_further_Zmass_Pt_fmu.Write()
  h_double_Pt_tetmu_pid.Write()
  h_double_Pt_tetmu.Write()
  h_closer_Zmass_Pt_tetmu_pid.Write()
  h_further_Zmass_Pt_tetmu_pid.Write()
  h_closer_Zmass_Pt_tetmu.Write()
  h_further_Zmass_Pt_tetmu.Write()
  h_double_Pt_eemumu.Write()
  h_double_Pt_mumuee.Write()
  h_double_Pt_eemumu_Z.Write()
  h_double_Pt_mumuee_Z.Write()
  h_closer_Zmass_Pt_eemumu.Write()
  h_further_Zmass_Pt_eemumu.Write()
  h_closer_Zmass_Pt_mumuee.Write()
  h_further_Zmass_Pt_mumuee.Write()
  h_closer_Zmass_Pt_eemumu_Z.Write()
  h_further_Zmass_Pt_eemumu_Z.Write()
  h_closer_Zmass_Pt_mumuee_Z.Write()
  h_further_Zmass_Pt_mumuee_Z.Write()

  h_double_eta_lep_pid.Write()
  h_double_eta_lep.Write()
  h_closer_Zmass_eta_lep_pid.Write()
  h_further_Zmass_eta_lep_pid.Write()
  h_closer_Zmass_eta_lep.Write()
  h_further_Zmass_eta_lep.Write()
  h_double_eta_fe_pid.Write()
  h_double_eta_fe.Write()
  h_closer_Zmass_eta_fe_pid.Write()
  h_further_Zmass_eta_fe_pid.Write()
  h_closer_Zmass_eta_fe.Write()
  h_further_Zmass_eta_fe.Write()
  h_double_eta_fmu_pid.Write()
  h_double_eta_fmu.Write()
  h_closer_Zmass_eta_fmu_pid.Write()
  h_further_Zmass_eta_fmu_pid.Write()
  h_closer_Zmass_eta_fmu.Write()
  h_further_Zmass_eta_fmu.Write()
  h_double_eta_tetmu_pid.Write()
  h_double_eta_tetmu.Write()
  h_closer_Zmass_eta_tetmu_pid.Write()
  h_further_Zmass_eta_tetmu_pid.Write()
  h_closer_Zmass_eta_tetmu.Write()
  h_further_Zmass_eta_tetmu.Write()
  h_double_eta_eemumu.Write()
  h_double_eta_mumuee.Write()
  h_double_eta_eemumu_Z.Write()
  h_double_eta_mumuee_Z.Write()
  h_closer_Zmass_eta_eemumu.Write()
  h_further_Zmass_eta_eemumu.Write()
  h_closer_Zmass_eta_mumuee.Write()
  h_further_Zmass_eta_mumuee.Write()
  h_closer_Zmass_eta_eemumu_Z.Write()
  h_further_Zmass_eta_eemumu_Z.Write()
  h_closer_Zmass_eta_mumuee_Z.Write()
  h_further_Zmass_eta_mumuee_Z.Write()
