...
def plot(InputROOTFile):
  ...
  h_Theta3 = rootfile.Get("Theta3")
  h_Theta4 = rootfile.Get("Theta4")

  h_TTTheta1 = rootfile.Get("TTTheta1")
  h_TTTheta2 = rootfile.Get("TTTheta2")
  h_TTTheta3 = rootfile.Get("TTTheta3")
  h_TTTheta4 = rootfile.Get("TTTheta4")
  h_TLTheta1 = rootfile.Get("TLTheta1")
  h_TLTheta2 = rootfile.Get("TLTheta2")
  h_TLTheta3 = rootfile.Get("TLTheta3")
  h_TLTheta4 = rootfile.Get("TLTheta4")
  h_LLTheta1 = rootfile.Get("LLTheta1")
  h_LLTheta2 = rootfile.Get("LLTheta2")
  h_LLTheta3 = rootfile.Get("LLTheta3")
  h_LLTheta4 = rootfile.Get("LLTheta4")
  ...
  h_Theta3.Scale(0.02419*139*1000/20000)
  h_Theta4.Scale(0.02419*139*1000/20000)

  h_TTTheta1.Scale(0.01688*139*1000/20000)
  h_TTTheta2.Scale(0.01688*139*1000/20000)
  h_TTTheta3.Scale(0.01688*139*1000/20000)
  h_TTTheta4.Scale(0.01688*139*1000/20000)

  h_TLTheta1.Scale(0.005741*139*1000/20000)
  h_TLTheta2.Scale(0.005741*139*1000/20000)
  h_TLTheta3.Scale(0.005741*139*1000/20000)
  h_TLTheta4.Scale(0.005741*139*1000/20000)

  h_LLTheta1.Scale(0.001406*139*1000/20000)
  h_LLTheta2.Scale(0.001406*139*1000/20000)
  h_LLTheta3.Scale(0.001406*139*1000/20000)
  h_LLTheta4.Scale(0.001406*139*1000/20000)
  ...
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_AddTheta3 = R.TH1F("TT+TL+LLTheta3", "", nbins, xmin, xmax)
  h_AddTheta3.Add(h_TTTheta3, 1)
  h_AddTheta3.Add(h_TLTheta3, 1)
  h_AddTheta3.Add(h_LLTheta3, 1)

  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_AddTheta4 = R.TH1F("TT+TL+LLTheta4", "", nbins, xmin, xmax)
  h_AddTheta4.Add(h_TTTheta4, 1)
  h_AddTheta4.Add(h_TLTheta4, 1)
  h_AddTheta4.Add(h_LLTheta4, 1)
  ...
  h_Theta3Divide = R.TH1F("Theta3Divide", "", 40, 0, R.TMath.Pi())
  h_TTTheta3Divide = R.TH1F("TTTheta3Divide", "", 40, 0, R.TMath.Pi())
  h_TLTheta3Divide = R.TH1F("TLTheta3Divide", "", 40, 0, R.TMath.Pi())
  h_LLTheta3Divide = R.TH1F("LLTheta3Divide", "", 40, 0, R.TMath.Pi())
  h_AddTheta3Divide = R.TH1F("AddTheta3Divide", "", 40, 0, R.TMath.Pi())

  h_Theta4Divide = R.TH1F("Theta4Divide", "", 40, 0, R.TMath.Pi())
  h_TTTheta4Divide = R.TH1F("TTTheta4Divide", "", 40, 0, R.TMath.Pi())
  h_TLTheta4Divide = R.TH1F("TLTheta4Divide", "", 40, 0, R.TMath.Pi())
  h_LLTheta4Divide = R.TH1F("LLTheta4Divide", "", 40, 0, R.TMath.Pi())
  h_AddTheta4Divide = R.TH1F("AddTheta4Divide", "", 40, 0, R.TMath.Pi())
  ...
  h_Theta3DivideShape = R.TH1F("Theta3DivideShape", "", 40, 0, R.TMath.Pi())
  h_TTTheta3DivideShape = R.TH1F("TTTheta3DivideShape", "", 40, 0, R.TMath.Pi())
  h_TLTheta3DivideShape = R.TH1F("TLTheta3DivideShape", "", 40, 0, R.TMath.Pi())
  h_LLTheta3DivideShape = R.TH1F("LLTheta3DivideShape", "", 40, 0, R.TMath.Pi())
  h_AddTheta3DivideShape = R.TH1F("AddTheta3DivideShape", "", 40, 0, R.TMath.Pi())

  h_Theta4DivideShape = R.TH1F("Theta4DivideShape", "", 40, 0, R.TMath.Pi())
  h_TTTheta4DivideShape = R.TH1F("TTTheta4DivideShape", "", 40, 0, R.TMath.Pi())
  h_TLTheta4DivideShape = R.TH1F("TLTheta4DivideShape", "", 40, 0, R.TMath.Pi())
  h_LLTheta4DivideShape = R.TH1F("LLTheta4DivideShape", "", 40, 0, R.TMath.Pi())
  h_AddTheta4DivideShape = R.TH1F("AddTheta4DivideShape", "", 40, 0, R.TMath.Pi())
  ...
  hs_Theta3 = R.THStack("hs_Theta3", "")
  h_LLTheta3Clone1 = h_LLTheta3.Clone("h_LLTheta3Clone1")
  h_TLTheta3Clone1 = h_TLTheta3.Clone("h_TLTheta3Clone1")
  h_TTTheta3Clone1 = h_TTTheta3.Clone("h_TTTheta3Clone1")
  h_LLTheta3Clone1.SetLineWidth(0)
  h_TLTheta3Clone1.SetLineWidth(0)
  h_TTTheta3Clone1.SetLineWidth(0)
  hs_Theta3.Add(h_LLTheta3Clone1, "Hist")
  hs_Theta3.Add(h_TLTheta3Clone1, "SameHist")
  hs_Theta3.Add(h_TTTheta3Clone1, "SameHist")

  hs_Theta4 = R.THStack("hs_Theta4", "")
  h_LLTheta4Clone1 = h_LLTheta4.Clone("h_LLTheta4Clone1")
  h_TLTheta4Clone1 = h_TLTheta4.Clone("h_TLTheta4Clone1")
  h_TTTheta4Clone1 = h_TTTheta4.Clone("h_TTTheta4Clone1")
  h_LLTheta4Clone1.SetLineWidth(0)
  h_TLTheta4Clone1.SetLineWidth(0)
  h_TTTheta4Clone1.SetLineWidth(0)
  hs_Theta4.Add(h_LLTheta4Clone1, "Hist")
  hs_Theta4.Add(h_TLTheta4Clone1, "SameHist")
  hs_Theta4.Add(h_TTTheta4Clone1, "SameHist")
  ...
  h_Theta3Clone2 = h_Theta3.Clone("h_Theta3Clone2")
  h_TTTheta3Clone2 = h_TTTheta3.Clone("h_TTTheta3Clone2")
  h_TLTheta3Clone2 = h_TLTheta3.Clone("h_TLTheta3Clone2")
  h_LLTheta3Clone2 = h_LLTheta3.Clone("h_LLTheta3Clone2")
  h_AddTheta3Clone2 = h_AddTheta3.Clone("h_AddTheta3Clone2")

  h_Theta4Clone2 = h_Theta4.Clone("h_Theta4Clone2")
  h_TTTheta4Clone2 = h_TTTheta4.Clone("h_TTTheta4Clone2")
  h_TLTheta4Clone2 = h_TLTheta4.Clone("h_TLTheta4Clone2")
  h_LLTheta4Clone2 = h_LLTheta4.Clone("h_LLTheta4Clone2")
  h_AddTheta4Clone2 = h_AddTheta4.Clone("h_AddTheta4Clone2")
  ...
  h_Theta3Clone2.Scale(1/h_Theta3Clone2.Integral())
  h_TTTheta3Clone2.Scale(1/h_TTTheta3Clone2.Integral())
  h_TLTheta3Clone2.Scale(1/h_TLTheta3Clone2.Integral())
  h_LLTheta3Clone2.Scale(1/h_LLTheta3Clone2.Integral())
  h_AddTheta3Clone2.Scale(1/h_AddTheta3Clone2.Integral())

  h_Theta4Clone2.Scale(1/h_Theta4Clone2.Integral())
  h_TTTheta4Clone2.Scale(1/h_TTTheta4Clone2.Integral())
  h_TLTheta4Clone2.Scale(1/h_TLTheta4Clone2.Integral())
  h_LLTheta4Clone2.Scale(1/h_LLTheta4Clone2.Integral())
  h_AddTheta4Clone2.Scale(1/h_AddTheta4Clone2.Integral())
  ...
  h_CosTheta3.Draw("SameHE")
  h_TTCosTheta3.Draw("SameHE")
  h_TLCosTheta3.Draw("SameHE")
  h_LLCosTheta3.Draw("SameHE")
  h_AddCosTheta3.Draw("SameHE")
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_TTCosTheta3Clone1, "TTStack", "F")
  leg.AddEntry(h_TLCosTheta3Clone1, "TLStack", "F")
  leg.AddEntry(h_LLCosTheta3Clone1, "LLStack", "F")
  ...
  # draw the histograms of ratio
  h_CosTheta3Divide.Draw("HE")
  h_TTCosTheta3Divide.Draw("SameHE")
  h_TLCosTheta3Divide.Draw("SameHE")
  h_LLCosTheta3Divide.Draw("SameHE")
  h_AddCosTheta3Divide.Draw("SameHE")
  # set the color of each histogram
  ...
  # draw histograms in this pad
  h_CosTheta3Clone2.Draw("HE")
  h_TTCosTheta3Clone2.Draw("SameHE")
  h_TLCosTheta3Clone2.Draw("SameHE")
  h_LLCosTheta3Clone2.Draw("SameHE")
  h_AddCosTheta3Clone2.Draw("SameHE")
  ...
  # draw the histograms of ratio
  h_CosTheta3DivideShape.Draw("HE")
  h_TTCosTheta3DivideShape.Draw("SameHE")
  h_TLCosTheta3DivideShape.Draw("SameHE")
  h_LLCosTheta3DivideShape.Draw("SameHE")
  h_AddCosTheta3DivideShape.Draw("SameHE")
  # set the color of each histogram
  ...
  h_CosTheta4.Draw("SameHE")
  h_TTCosTheta4.Draw("SameHE")
  h_TLCosTheta4.Draw("SameHE")
  h_LLCosTheta4.Draw("SameHE")
  h_AddCosTheta4.Draw("SameHE")
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_TTCosTheta4Clone1, "TTStack", "F")
  leg.AddEntry(h_TLCosTheta4Clone1, "TLStack", "F")
  leg.AddEntry(h_LLCosTheta4Clone1, "LLStack", "F")
  ...
  # draw the histograms of ratio
  h_CosTheta4Divide.Draw("HE")
  h_TTCosTheta4Divide.Draw("SameHE")
  h_TLCosTheta4Divide.Draw("SameHE")
  h_LLCosTheta4Divide.Draw("SameHE")
  h_AddCosTheta4Divide.Draw("SameHE")
  # set the color of each histogram
  ...
  # draw histograms in this pad
  h_CosTheta4Clone2.Draw("HE")
  h_TTCosTheta4Clone2.Draw("SameHE")
  h_TLCosTheta4Clone2.Draw("SameHE")
  h_LLCosTheta4Clone2.Draw("SameHE")
  h_AddCosTheta4Clone2.Draw("SameHE")
  ...
  # draw the histograms of ratio
  h_CosTheta4DivideShape.Draw("HE")
  h_TTCosTheta4DivideShape.Draw("SameHE")
  h_TLCosTheta4DivideShape.Draw("SameHE")
  h_LLCosTheta4DivideShape.Draw("SameHE")
  h_AddCosTheta4DivideShape.Draw("SameHE")
  # set the color of each histogram
  ...
  """
  histogram of Theta3, TTTheta3, TLTheta3, LLTheta3, TT+TL+LLTheta3
  """

  # create a canvas, set the name, title, pixels of x, pixels of y
  c_Theta3Sum = R.TCanvas("c_Theta3Sum", "Theta3Sum", 800, 1000)
  # set the background of this canvas
  c_Theta3Sum.SetFillColor(0)
  ...
  # draw histograms in this pad
  hs_Theta3.Draw("Hist")
  h_Theta3.Draw("SameHE")
  h_TTTheta3.Draw("SameHE")
  h_TLTheta3.Draw("SameHE")
  h_LLTheta3.Draw("SameHE")
  h_AddTheta3.Draw("SameHE")

  # set the fill color of histogram TTClone, TLClone and LLClone, since it will be used in THStack
  h_LLTheta3Clone1.SetFillColor(2)
  h_TLTheta3Clone1.SetFillColor(3)
  h_TTTheta3Clone1.SetFillColor(9)

  # set the line color of each histogram
  h_Theta3.SetLineColor(1)
  h_TTTheta3.SetLineColor(7)
  h_TLTheta3.SetLineColor(11)
  h_LLTheta3.SetLineColor(5)
  h_AddTheta3.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta3.SetLineWidth(3)
  h_TTTheta3.SetLineWidth(3)
  h_TLTheta3.SetLineWidth(3)
  h_LLTheta3.SetLineWidth(3)
  h_AddTheta3.SetLineWidth(3)

  # Since we draw the THStack first, so we just need to change the range of THStack to make the Canvas suitable
  # set the font and size of each axis
  hs_Theta3.GetXaxis().SetLabelFont(63)
  hs_Theta3.GetXaxis().SetLabelSize(16)
  hs_Theta3.GetYaxis().SetLabelFont(63)
  hs_Theta3.GetYaxis().SetLabelSize(16)
  # set the size of y axis's title
  hs_Theta3.GetYaxis().SetTitle("Events")
  hs_Theta3.GetYaxis().SetTitleSize(0.035)
  # set the range of y axis
  """
  A problem: hs_M1.GetYaxis().SetRangeUser(0, 1000) seems not valid when the object is THStack, so I use SetMaximum
  """
  hs_Theta3.SetMaximum(int(hs_Theta3.GetMaximum())*1.2)
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_TTTheta3Clone1, "TTStack", "F")
  leg.AddEntry(h_TLTheta3Clone1, "TLStack", "F")
  leg.AddEntry(h_LLTheta3Clone1, "LLStack", "F")
  leg.AddEntry(h_Theta3,"Inclusive","LE")
  leg.AddEntry(h_TTTheta3,"TT","LE")
  leg.AddEntry(h_TLTheta3,"TL","LE")
  leg.AddEntry(h_LLTheta3,"LL","LE")
  leg.AddEntry(h_AddTheta3,"TT+TL+LL","LE")
  leg.Draw()
  ...
  # draw the histogram in this pad
  # use class Divide to calculate the ratio to TT+TL+LL, set the weight of 2 histograms
  h_Theta3Divide.Divide(h_Theta3, h_AddTheta3, 1, 1)
  h_TTTheta3Divide.Divide(h_TTTheta3, h_AddTheta3, 1, 1)
  h_TLTheta3Divide.Divide(h_TLTheta3, h_AddTheta3, 1, 1)
  h_LLTheta3Divide.Divide(h_LLTheta3, h_AddTheta3, 1, 1)
  h_AddTheta3Divide.Divide(h_AddTheta3, h_AddTheta3, 1 ,1)

  # draw the histograms of ratio
  h_Theta3Divide.Draw("HE")
  h_TTTheta3Divide.Draw("SameHE")
  h_TLTheta3Divide.Draw("SameHE")
  h_LLTheta3Divide.Draw("SameHE")
  h_AddTheta3Divide.Draw("SameHE")
  # set the color of each histogram
  h_Theta3Divide.SetLineColor(1)
  h_TTTheta3Divide.SetLineColor(7)
  h_TLTheta3Divide.SetLineColor(11)
  h_LLTheta3Divide.SetLineColor(5)
  h_AddTheta3Divide.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta3Divide.SetLineWidth(3)
  h_TTTheta3Divide.SetLineWidth(3)
  h_TLTheta3Divide.SetLineWidth(3)
  h_LLTheta3Divide.SetLineWidth(3)
  h_AddTheta3Divide.SetLineWidth(3)
  # set the font and size of each axis
  h_Theta3Divide.GetXaxis().SetLabelFont(63)
  h_Theta3Divide.GetXaxis().SetLabelSize(16)
  h_Theta3Divide.GetYaxis().SetLabelFont(63)
  h_Theta3Divide.GetYaxis().SetLabelSize(16)
  # set the title and title size of x axis and y axis
  h_Theta3Divide.GetXaxis().SetTitle("Theta3")
  h_Theta3Divide.GetXaxis().SetTitleSize(0.07)
  h_Theta3Divide.GetYaxis().SetTitle("Ratio to TT+TL+LL")
  h_Theta3Divide.GetYaxis().SetTitleSize(0.07)
  # set the range of y axis
  Max1 = h_Theta3Divide.GetMaximum()
  Max2 = h_TTTheta3Divide.GetMaximum()
  Max3 = h_TLTheta3Divide.GetMaximum()
  Max4 = h_LLTheta3Divide.GetMaximum()
  Max5 = h_AddTheta3Divide.GetMaximum()
  Min1 = h_Theta3Divide.GetMinimum()
  Min2 = h_TTTheta3Divide.GetMinimum()
  Min3 = h_TLTheta3Divide.GetMinimum()
  Min4 = h_LLTheta3Divide.GetMinimum()
  Min5 = h_AddTheta3Divide.GetMinimum()
  h_Theta3Divide.GetYaxis().SetRangeUser(min(Min1, Min2, Min3, Min4, Min5)*0.1, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  # After finishing drawing histogram in 2ed pad, enter the canvas
  c_Theta3Sum.cd()

  # save the canvas as png file
  c_Theta3Sum.SaveAs("Theta3Sum.png")
  # close the canvas
  c_Theta3Sum.Close()


  # create a canvas, set the name, title, pixels of x, pixels of y
  c_Theta3SumShape = R.TCanvas("c_Theta3SumShape", "Theta3SumShape", 800, 1000)
  # set the background of this canvas
  c_Theta3SumShape.SetFillColor(0)
  ...
  # draw histograms in this pad
  h_Theta3Clone2.Draw("HE")
  h_TTTheta3Clone2.Draw("SameHE")
  h_TLTheta3Clone2.Draw("SameHE")
  h_LLTheta3Clone2.Draw("SameHE")
  h_AddTheta3Clone2.Draw("SameHE")

  # set the line color of each histogram
  h_Theta3Clone2.SetLineColor(1)
  h_TTTheta3Clone2.SetLineColor(7)
  h_TLTheta3Clone2.SetLineColor(11)
  h_LLTheta3Clone2.SetLineColor(5)
  h_AddTheta3Clone2.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta3Clone2.SetLineWidth(3)
  h_TTTheta3Clone2.SetLineWidth(3)
  h_TLTheta3Clone2.SetLineWidth(3)
  h_LLTheta3Clone2.SetLineWidth(3)
  h_AddTheta3Clone2.SetLineWidth(3)

  # Since we draw the THStack first, so we just need to change the range of THStack to make the Canvas suitable
  # set the font and size of each axis
  h_Theta3Clone2.GetXaxis().SetLabelFont(63)
  h_Theta3Clone2.GetXaxis().SetLabelSize(16)
  h_Theta3Clone2.GetYaxis().SetLabelFont(63)
  h_Theta3Clone2.GetYaxis().SetLabelSize(16)
  # set the size of y axis's title
  h_Theta3Clone2.GetYaxis().SetTitle("freq.")
  h_Theta3Clone2.GetYaxis().SetTitleSize(0.035)
  # set the range of y axis
  Max1 = h_Theta3Clone2.GetMaximum()
  Max2 = h_TTTheta3Clone2.GetMaximum()
  Max3 = h_TLTheta3Clone2.GetMaximum()
  Max4 = h_LLTheta3Clone2.GetMaximum()
  Max5 = h_AddTheta3Clone2.GetMaximum()
  h_Theta3Clone2.GetYaxis().SetRangeUser(0, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_Theta3Clone2,"Inclusive","LE")
  leg.AddEntry(h_TTTheta3Clone2,"TT","LE")
  leg.AddEntry(h_TLTheta3Clone2,"TL","LE")
  leg.AddEntry(h_LLTheta3Clone2,"LL","LE")
  leg.AddEntry(h_AddTheta3Clone2,"TT+TL+LL","LE")
  leg.Draw()
  ...
  # draw the histogram in this pad
  # use class Divide to calculate the ratio to TT+TL+LL, set the weight of 2 histograms
  h_Theta3DivideShape.Divide(h_Theta3Clone2, h_AddTheta3Clone2, 1, 1)
  h_TTTheta3DivideShape.Divide(h_TTTheta3Clone2, h_AddTheta3Clone2, 1, 1)
  h_TLTheta3DivideShape.Divide(h_TLTheta3Clone2, h_AddTheta3Clone2, 1, 1)
  h_LLTheta3DivideShape.Divide(h_LLTheta3Clone2, h_AddTheta3Clone2, 1, 1)
  h_AddTheta3DivideShape.Divide(h_AddTheta3Clone2, h_AddTheta3Clone2, 1 ,1)

  # draw the histograms of ratio
  h_Theta3DivideShape.Draw("HE")
  h_TTTheta3DivideShape.Draw("SameHE")
  h_TLTheta3DivideShape.Draw("SameHE")
  h_LLTheta3DivideShape.Draw("SameHE")
  h_AddTheta3DivideShape.Draw("SameHE")
  # set the color of each histogram
  h_Theta3DivideShape.SetLineColor(1)
  h_TTTheta3DivideShape.SetLineColor(7)
  h_TLTheta3DivideShape.SetLineColor(11)
  h_LLTheta3DivideShape.SetLineColor(5)
  h_AddTheta3DivideShape.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta3DivideShape.SetLineWidth(3)
  h_TTTheta3DivideShape.SetLineWidth(3)
  h_TLTheta3DivideShape.SetLineWidth(3)
  h_LLTheta3DivideShape.SetLineWidth(3)
  h_AddTheta3DivideShape.SetLineWidth(3)
  # set the font and size of each axis
  h_Theta3DivideShape.GetXaxis().SetLabelFont(63)
  h_Theta3DivideShape.GetXaxis().SetLabelSize(16)
  h_Theta3DivideShape.GetYaxis().SetLabelFont(63)
  h_Theta3DivideShape.GetYaxis().SetLabelSize(16)
  # set the title and title size of x axis and y axis
  h_Theta3DivideShape.GetXaxis().SetTitle("Theta3")
  h_Theta3DivideShape.GetXaxis().SetTitleSize(0.07)
  h_Theta3DivideShape.GetYaxis().SetTitle("Ratio to TT+TL+LL")
  h_Theta3DivideShape.GetYaxis().SetTitleSize(0.07)
  # set the range of y axis
  Max1 = h_Theta3DivideShape.GetMaximum()
  Max2 = h_TTTheta3DivideShape.GetMaximum()
  Max3 = h_TLTheta3DivideShape.GetMaximum()
  Max4 = h_LLTheta3DivideShape.GetMaximum()
  Max5 = h_AddTheta3DivideShape.GetMaximum()
  Min1 = h_Theta3DivideShape.GetMinimum()
  Min2 = h_TTTheta3DivideShape.GetMinimum()
  Min3 = h_TLTheta3DivideShape.GetMinimum()
  Min4 = h_LLTheta3DivideShape.GetMinimum()
  Min5 = h_AddTheta3DivideShape.GetMinimum()
  h_Theta3DivideShape.GetYaxis().SetRangeUser(min(Min1, Min2, Min3, Min4, Min5)*0.5, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  # After finishing drawing histogram in 2ed pad, enter the canvas
  c_Theta3SumShape.cd()


  # save the canvas as png file
  c_Theta3SumShape.SaveAs("Theta3ShapeOnly.png")
  # close the canvas
  c_Theta3SumShape.Close()



  """
  histogram of Theta4, TTTheta4, TLTheta4, LLTheta4, TT+TL+LLTheta4
  """

  # create a canvas, set the name, title, pixels of x, pixels of y
  c_Theta4Sum = R.TCanvas("c_Theta4Sum", "Theta4Sum", 800, 1000)
  # set the background of this canvas
  c_Theta4Sum.SetFillColor(0)
  ...
  # draw histograms in this pad
  hs_Theta4.Draw("Hist")
  h_Theta4.Draw("SameHE")
  h_TTTheta4.Draw("SameHE")
  h_TLTheta4.Draw("SameHE")
  h_LLTheta4.Draw("SameHE")
  h_AddTheta4.Draw("SameHE")

  # set the fill color of histogram TTClone, TLClone and LLClone, since it will be used in THStack
  h_LLTheta4Clone1.SetFillColor(2)
  h_TLTheta4Clone1.SetFillColor(3)
  h_TTTheta4Clone1.SetFillColor(9)

  # set the line color of each histogram
  h_Theta4.SetLineColor(1)
  h_TTTheta4.SetLineColor(7)
  h_TLTheta4.SetLineColor(11)
  h_LLTheta4.SetLineColor(5)
  h_AddTheta4.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta4.SetLineWidth(3)
  h_TTTheta4.SetLineWidth(3)
  h_TLTheta4.SetLineWidth(3)
  h_LLTheta4.SetLineWidth(3)
  h_AddTheta4.SetLineWidth(3)

  # Since we draw the THStack first, so we just need to change the range of THStack to make the Canvas suitable
  # set the font and size of each axis
  hs_Theta4.GetXaxis().SetLabelFont(63)
  hs_Theta4.GetXaxis().SetLabelSize(16)
  hs_Theta4.GetYaxis().SetLabelFont(63)
  hs_Theta4.GetYaxis().SetLabelSize(16)
  # set the size of y axis's title
  hs_Theta4.GetYaxis().SetTitle("Events")
  hs_Theta4.GetYaxis().SetTitleSize(0.035)
  # set the range of y axis
  """
  A problem: hs_M1.GetYaxis().SetRangeUser(0, 1000) seems not valid when the object is THStack, so I use SetMaximum
  """
  hs_Theta4.SetMaximum(int(hs_Theta4.GetMaximum())*1.2)
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_TTTheta4Clone1, "TTStack", "F")
  leg.AddEntry(h_TLTheta4Clone1, "TLStack", "F")
  leg.AddEntry(h_LLTheta4Clone1, "LLStack", "F")
  leg.AddEntry(h_Theta4,"Inclusive","LE")
  leg.AddEntry(h_TTTheta4,"TT","LE")
  leg.AddEntry(h_TLTheta4,"TL","LE")
  leg.AddEntry(h_LLTheta4,"LL","LE")
  leg.AddEntry(h_AddTheta4,"TT+TL+LL","LE")
  leg.Draw()
  ...
  # draw the histogram in this pad
  # use class Divide to calculate the ratio to TT+TL+LL, set the weight of 2 histograms
  h_Theta4Divide.Divide(h_Theta4, h_AddTheta4, 1, 1)
  h_TTTheta4Divide.Divide(h_TTTheta4, h_AddTheta4, 1, 1)
  h_TLTheta4Divide.Divide(h_TLTheta4, h_AddTheta4, 1, 1)
  h_LLTheta4Divide.Divide(h_LLTheta4, h_AddTheta4, 1, 1)
  h_AddTheta4Divide.Divide(h_AddTheta4, h_AddTheta4, 1 ,1)

  # draw the histograms of ratio
  h_Theta4Divide.Draw("HE")
  h_TTTheta4Divide.Draw("SameHE")
  h_TLTheta4Divide.Draw("SameHE")
  h_LLTheta4Divide.Draw("SameHE")
  h_AddTheta4Divide.Draw("SameHE")
  # set the color of each histogram
  h_Theta4Divide.SetLineColor(1)
  h_TTTheta4Divide.SetLineColor(7)
  h_TLTheta4Divide.SetLineColor(11)
  h_LLTheta4Divide.SetLineColor(5)
  h_AddTheta4Divide.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta4Divide.SetLineWidth(3)
  h_TTTheta4Divide.SetLineWidth(3)
  h_TLTheta4Divide.SetLineWidth(3)
  h_LLTheta4Divide.SetLineWidth(3)
  h_AddTheta4Divide.SetLineWidth(3)
  # set the font and size of each axis
  h_Theta4Divide.GetXaxis().SetLabelFont(63)
  h_Theta4Divide.GetXaxis().SetLabelSize(16)
  h_Theta4Divide.GetYaxis().SetLabelFont(63)
  h_Theta4Divide.GetYaxis().SetLabelSize(16)
  # set the title and title size of x axis and y axis
  h_Theta4Divide.GetXaxis().SetTitle("Theta4")
  h_Theta4Divide.GetXaxis().SetTitleSize(0.07)
  h_Theta4Divide.GetYaxis().SetTitle("Ratio to TT+TL+LL")
  h_Theta4Divide.GetYaxis().SetTitleSize(0.07)
  # set the range of y axis
  Max1 = h_Theta4Divide.GetMaximum()
  Max2 = h_TTTheta4Divide.GetMaximum()
  Max3 = h_TLTheta4Divide.GetMaximum()
  Max4 = h_LLTheta4Divide.GetMaximum()
  Max5 = h_AddTheta4Divide.GetMaximum()
  Min1 = h_Theta4Divide.GetMinimum()
  Min2 = h_TTTheta4Divide.GetMinimum()
  Min3 = h_TLTheta4Divide.GetMinimum()
  Min4 = h_LLTheta4Divide.GetMinimum()
  Min5 = h_AddTheta4Divide.GetMinimum()
  h_Theta4Divide.GetYaxis().SetRangeUser(min(Min1, Min2, Min3, Min4, Min5)*0.1, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  # After finishing drawing histogram in 2ed pad, enter the canvas
  c_Theta4Sum.cd()

  # save the canvas as png file
  c_Theta4Sum.SaveAs("Theta4Sum.png")
  # close the canvas
  c_Theta4Sum.Close()


  # create a canvas, set the name, title, pixels of x, pixels of y
  c_Theta4SumShape = R.TCanvas("c_Theta4SumShape", "Theta4SumShape", 800, 1000)
  # set the background of this canvas
  c_Theta4SumShape.SetFillColor(0)
  ...
  # draw histograms in this pad
  h_Theta4Clone2.Draw("HE")
  h_TTTheta4Clone2.Draw("SameHE")
  h_TLTheta4Clone2.Draw("SameHE")
  h_LLTheta4Clone2.Draw("SameHE")
  h_AddTheta4Clone2.Draw("SameHE")

  # set the line color of each histogram
  h_Theta4Clone2.SetLineColor(1)
  h_TTTheta4Clone2.SetLineColor(7)
  h_TLTheta4Clone2.SetLineColor(11)
  h_LLTheta4Clone2.SetLineColor(5)
  h_AddTheta4Clone2.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta4Clone2.SetLineWidth(3)
  h_TTTheta4Clone2.SetLineWidth(3)
  h_TLTheta4Clone2.SetLineWidth(3)
  h_LLTheta4Clone2.SetLineWidth(3)
  h_AddTheta4Clone2.SetLineWidth(3)

  # Since we draw the THStack first, so we just need to change the range of THStack to make the Canvas suitable
  # set the font and size of each axis
  h_Theta4Clone2.GetXaxis().SetLabelFont(63)
  h_Theta4Clone2.GetXaxis().SetLabelSize(16)
  h_Theta4Clone2.GetYaxis().SetLabelFont(63)
  h_Theta4Clone2.GetYaxis().SetLabelSize(16)
  # set the size of y axis's title
  h_Theta4Clone2.GetYaxis().SetTitle("freq.")
  h_Theta4Clone2.GetYaxis().SetTitleSize(0.035)
  # set the range of y axis
  Max1 = h_Theta4Clone2.GetMaximum()
  Max2 = h_TTTheta4Clone2.GetMaximum()
  Max3 = h_TLTheta4Clone2.GetMaximum()
  Max4 = h_LLTheta4Clone2.GetMaximum()
  Max5 = h_AddTheta4Clone2.GetMaximum()
  h_Theta4Clone2.GetYaxis().SetRangeUser(0, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  ...
  "l" means line, "p" means polymarker, "f" means box, "e" means draw vertical error bar if option "L" is also specified
  """
  leg.AddEntry(h_Theta4Clone2,"Inclusive","LE")
  leg.AddEntry(h_TTTheta4Clone2,"TT","LE")
  leg.AddEntry(h_TLTheta4Clone2,"TL","LE")
  leg.AddEntry(h_LLTheta4Clone2,"LL","LE")
  leg.AddEntry(h_AddTheta4Clone2,"TT+TL+LL","LE")
  leg.Draw()
  ...
  # draw the histogram in this pad
  # use class Divide to calculate the ratio to TT+TL+LL, set the weight of 2 histograms
  h_Theta4DivideShape.Divide(h_Theta4Clone2, h_AddTheta4Clone2, 1, 1)
  h_TTTheta4DivideShape.Divide(h_TTTheta4Clone2, h_AddTheta4Clone2, 1, 1)
  h_TLTheta4DivideShape.Divide(h_TLTheta4Clone2, h_AddTheta4Clone2, 1, 1)
  h_LLTheta4DivideShape.Divide(h_LLTheta4Clone2, h_AddTheta4Clone2, 1, 1)
  h_AddTheta4DivideShape.Divide(h_AddTheta4Clone2, h_AddTheta4Clone2, 1 ,1)

  # draw the histograms of ratio
  h_Theta4DivideShape.Draw("HE")
  h_TTTheta4DivideShape.Draw("SameHE")
  h_TLTheta4DivideShape.Draw("SameHE")
  h_LLTheta4DivideShape.Draw("SameHE")
  h_AddTheta4DivideShape.Draw("SameHE")
  # set the color of each histogram
  h_Theta4DivideShape.SetLineColor(1)
  h_TTTheta4DivideShape.SetLineColor(7)
  h_TLTheta4DivideShape.SetLineColor(11)
  h_LLTheta4DivideShape.SetLineColor(5)
  h_AddTheta4DivideShape.SetLineColor(46)
  # set the width of each histogram's line
  h_Theta4DivideShape.SetLineWidth(3)
  h_TTTheta4DivideShape.SetLineWidth(3)
  h_TLTheta4DivideShape.SetLineWidth(3)
  h_LLTheta4DivideShape.SetLineWidth(3)
  h_AddTheta4DivideShape.SetLineWidth(3)
  # set the font and size of each axis
  h_Theta4DivideShape.GetXaxis().SetLabelFont(63)
  h_Theta4DivideShape.GetXaxis().SetLabelSize(16)
  h_Theta4DivideShape.GetYaxis().SetLabelFont(63)
  h_Theta4DivideShape.GetYaxis().SetLabelSize(16)
  # set the title and title size of x axis and y axis
  h_Theta4DivideShape.GetXaxis().SetTitle("Theta4")
  h_Theta4DivideShape.GetXaxis().SetTitleSize(0.07)
  h_Theta4DivideShape.GetYaxis().SetTitle("Ratio to TT+TL+LL")
  h_Theta4DivideShape.GetYaxis().SetTitleSize(0.07)
  # set the range of y axis
  Max1 = h_Theta4DivideShape.GetMaximum()
  Max2 = h_TTTheta4DivideShape.GetMaximum()
  Max3 = h_TLTheta4DivideShape.GetMaximum()
  Max4 = h_LLTheta4DivideShape.GetMaximum()
  Max5 = h_AddTheta4DivideShape.GetMaximum()
  Min1 = h_Theta4DivideShape.GetMinimum()
  Min2 = h_TTTheta4DivideShape.GetMinimum()
  Min3 = h_TLTheta4DivideShape.GetMinimum()
  Min4 = h_LLTheta4DivideShape.GetMinimum()
  Min5 = h_AddTheta4DivideShape.GetMinimum()
  h_Theta4DivideShape.GetYaxis().SetRangeUser(min(Min1, Min2, Min3, Min4, Min5)*0.5, max(Max1, Max2, Max3, Max4, Max5)*1.2)
  # After finishing drawing histogram in 2ed pad, enter the canvas
  c_Theta4SumShape.cd()


  # save the canvas as png file
  c_Theta4SumShape.SaveAs("Theta4ShapeOnly.png")
  # close the canvas
  c_Theta4SumShape.Close()
