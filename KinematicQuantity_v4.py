...
def read_lhe(InputFileList):
  ...
  InclusiveTree.Branch("Phi", PhiCopy, "Phi/F")
  InclusiveTree.Branch("Phi1", Phi1Copy, "Phi1/F")
  ...
  TTTree.Branch("Phi", PhiCopy, "Phi/F")
  TTTree.Branch("Phi1", Phi1Copy, "Phi1/F")
  ...
  TLTree.Branch("Phi", PhiCopy, "Phi/F")
  TLTree.Branch("Phi1", Phi1Copy, "Phi1/F")
  ...
  LLTree.Branch("Phi", PhiCopy, "Phi/F")
  LLTree.Branch("Phi1", Phi1Copy, "Phi1/F")
  ...
  TTTLTree.Branch("Phi", PhiCopy, "Phi/F")
  TTTLTree.Branch("Phi1", Phi1Copy, "Phi1/F")
  ...
  for InputFile in InputFileList:
      ...
      for event in lhe:
          ...
          4 blocks: 1st function: histogram the M1, M2 and M4l;
                    ...
                    13th function: histogram the event weight
          """


          """
          block of 13th function: histogram the event weight
          """
          Weight[0] = event.wgt
          ...
          for i, deltamSort in enumerate(deltamSorts):
              ...
              if i == 0:
                  ...
                  if deltamSort == 0:
                      ...
                      Eta4l[0] = TEta4l.Eta()
          if np.isnan(Eta4l[0]) == True:
              print("1")
          if np.isnan(Eta1[0]) == True:
              print("1")
          if np.isnan(Eta2[0]) == True:
              print("1")
          ...
          if np.isnan(Pt4l[0]) == True:
              print("1")
          if np.isnan(Pt1[0]) == True:
              print("1")
          if np.isnan(Pt2[0]) == True:
              print("1")
  ...
  tfout = R.TFile("KinematicQuantity_v4.root", "RECREATE")
  tfout.cd()
