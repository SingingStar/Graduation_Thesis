...
def read_lhe(InputFileListSum):
  ...
  InclusiveTreeFile = R.TFile("InclusiveTree_ssh.root", "RECREATE")
  ...
  """
  # create a root file to save the tree
  TTTreeFile = R.TFile("TTTree_ssh.root", "RECREATE")
  # create a tree, define its name and title
  ...
  """
  # create a root file to save the tree
  TLTreeFile = R.TFile("TLTree_ssh.root", "RECREATE")
  # create a tree, define its name and title
  ...
  """
  # create a root file to save the tree
  LLTreeFile = R.TFile("LLTree_ssh.root", "RECREATE")
  # create a tree, define its name and title
  ...
  """
  # create a root file to save the tree
  TTTLTreeFile = R.TFile("TTTLTree_ssh.root", "RECREATE")
  # create a tree, define its name and title
  ...
  for InputFileList in InputFileListSum:
      ...
      for InputFile in InputFileList:
          ...
          for event in lhe:
              ...
              if InputFile in InputFileList_Inclusive:
                  h_M1.Fill(M1[0])
                  h_M2.Fill(M2[0])
              elif InputFile in InputFileList_TT:
                  h_TTM1.Fill(M1[0])
                  h_TTM2.Fill(M2[0])
              elif InputFile in InputFileList_TL:
                  h_TLM1.Fill(M1[0])
                  h_TLM2.Fill(M2[0])
              elif InputFile in InputFileList_LL:
                  h_LLM1.Fill(M1[0])
                  h_LLM2.Fill(M2[0])
  ...
  tfout = R.TFile("KinematicQuantity_ssh.root", "RECREATE")
  tfout.cd()
...
if __name__ == "__main__":
  ...
  for i in range(0, 50):
      InputFileList_Inclusive.append("/lustre/AtlUser/xwu/Condor/Output/ZZInclusive_v1/Run_{sort}/unweighted_events.lhe.gz".format(sort = i))

  for i in range(0, 50):
      InputFileList_TT.append("/lustre/AtlUser/xwu/Condor/Output/ZZTT_v1/Run_{sort}/unweighted_events.lhe.gz".format(sort = i))

  for i in range(0, 50):
      InputFileList_TL.append("/lustre/AtlUser/xwu/Condor/Output/ZZTL_v1/Run_{sort}/unweighted_events.lhe.gz".format(sort = i))

  for i in range(0, 50):
      InputFileList_LL.append("/lustre/AtlUser/xwu/Condor/Output/ZZLL_v1/Run_{sort}/unweighted_events.lhe.gz".format(sort = i))
