...
def TMVAApply(InputFile):
  ...
  InputFile = R.TFile.Open("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v4_Output/TLTree.root")

  data = InputFile.Get("TLTree")
  ...
  h_TL = R.TH1F("h_TL", "h_TL", 40, -1, 1)
  for i in range(0, data.GetEntries()):
      data.GetEntry(i)
      h_TL.Fill(reader.EvaluateMVA("BDT Method"))

  tfout = R.TFile("h_TL.root", "RECREATE")
  tfout.cd()
...
if __name__ == "__main__":
  ...
  InputFile = R.TFile("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v5_Output/TLTree.root")
