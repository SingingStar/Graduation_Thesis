...
def read_lhe(InputFileList):
  ...
  h_CosTheta3.SetTitle("CosTheta3;CosTheta3;events")
  ...
  h_CosTheta4.SetTitle("CosTheta4;CosTheta4;events")
  ...
  """
  histogram the Theta, "Theta3" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1
  """
  htitle = "Theta3"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_Theta3 = R.TH1F("Theta3", htitle, nbins, xmin, xmax)
  h_Theta3.SetTitle("Theta3;Theta1;events")

  """
  histogram the Theta, "Theta4" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1
  """
  htitle = "Theta4"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_Theta4 = R.TH1F("Theta4", htitle, nbins, xmin, xmax)
  h_Theta4.SetTitle("Theta4;Theta4;events")
  ...
  h_TTCosTheta3.SetTitle("TTCosTheta3;CosTheta3;events")
  ...
  h_TTCosTheta4.SetTitle("TTCosTheta4;CosTheta4;events")
  ...
  """
  histogram the Theta, "Theta3" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1, "TT" means the sort of polarization
  """
  htitle = "TTTheta3"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_TTTheta3 = R.TH1F("TTTheta3", htitle, nbins, xmin, xmax)
  h_TTTheta3.SetTitle("TTTheta3;Theta3;events")

  """
  histogram the Theta, "Theta4" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1, "TT" means the sort of polarization
  """
  htitle = "TTTheta4"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_TTTheta4 = R.TH1F("TTTheta4", htitle, nbins, xmin, xmax)
  h_TTTheta4.SetTitle("TTTheta4;Theta4;events")
  ...
  h_TLCosTheta3.SetTitle("TLCosTheta3;CosTheta3;events")
  ...
  h_TLCosTheta4.SetTitle("TLCosTheta4;CosTheta4;events")
  ...
  htitle = "TLTheta3"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_TLTheta3 = R.TH1F("TLTheta3", htitle, nbins, xmin, xmax)
  h_TLTheta3.SetTitle("TLTheta3;Theta3;events")
  ...
  htitle = "TLTheta4"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_TLTheta4 = R.TH1F("TLTheta4", htitle, nbins, xmin, xmax)
  h_TLTheta4.SetTitle("TLTheta4;Theta4;events")
  ...
  h_LLCosTheta3.SetTitle("LLCosTheta3;CosTheta3;events")
  ...
  h_LLCosTheta4.SetTitle("LLCosTheta4;CosTheta4;events")
  ...
  """
  histogram the Theta, "Theta3" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1, "LL" means the sort of polarization
  """
  htitle = "LLTheta3"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_LLTheta3 = R.TH1F("LLTheta3", htitle, nbins, xmin, xmax)
  h_LLTheta3.SetTitle("LLTheta3;Theta3;events")

  """
  histogram the Theta, "Theta4" means this is the angle between Z boson which is marked as "M1" and 1 lepton in 2 leptons which rebuild the M1, "LL" means the sort of polarization
  """
  htitle = "LLTheta4"
  nbins, xmin, xmax = 40, 0, R.TMath.Pi()
  h_LLTheta4 = R.TH1F("LLTheta4", htitle, nbins, xmin, xmax)
  h_LLTheta4.SetTitle("LLTheta4;Theta4;events")
  ...
  for InputFile in InputFileList:
      ...
      for event in lhe:
          ...
          PhiCopy = Phi
          if PhiCopy > R.TMath.PiOver2():
              PhiCopy = R.TMath.Pi() - PhiCopy
          if InputFile == InputFile_Inclusive:
              h_Phi.Fill(PhiCopy)
          elif InputFile == InputFile_TT:
              h_TTPhi.Fill(PhiCopy)
          elif InputFile == InputFile_TL:
              h_TLPhi.Fill(PhiCopy)
          elif InputFile == InputFile_LL:
              h_LLPhi.Fill(PhiCopy)
          ...
          Phi1Copy = Phi1
          if Phi1Copy > R.TMath.PiOver2():
              Phi1Copy = R.TMath.Pi() - Phi1Copy
          if InputFile == InputFile_Inclusive:
              h_Phi1.Fill(Phi1Copy)
          elif InputFile == InputFile_TT:
              h_TTPhi1.Fill(Phi1Copy)
          elif InputFile == InputFile_TL:
              h_TLPhi1.Fill(Phi1Copy)
          elif InputFile == InputFile_LL:
              h_LLPhi1.Fill(Phi1Copy)
          ...
          Theta1 = R.TMath.ACos(CosTheta1)
          Theta2 = R.TMath.ACos(CosTheta2)
          ...
          if InputFile == InputFile_Inclusive:
              ...
              h_TTTheta1.Fill(Theta1)
              h_TTTheta2.Fill(Theta2)
          elif InputFile == InputFile_TL:
              h_TLCosTheta1.Fill(CosTheta1)
              h_TLCosTheta2.Fill(CosTheta2)
              h_TLTheta1.Fill(Theta1)
              h_TLTheta2.Fill(Theta2)
          elif InputFile == InputFile_LL:
              h_LLCosTheta1.Fill(CosTheta1)
              h_LLCosTheta2.Fill(CosTheta2)
              h_LLTheta1.Fill(Theta1)
              h_LLTheta2.Fill(Theta2)
  ...
  tfout = R.TFile("Angle_v4.root", "RECREATE")
  tfout.cd()
