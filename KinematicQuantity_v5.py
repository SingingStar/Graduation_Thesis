...
def read_lhe(InputFileList):
  ...
  """
  htitle = "deltaR1"
  # since the range of deltaR larger than zero, define xmin = 0
  nbins, xmin, xmax = 40, 0, 5
  h_deltaR1 = R.TH1F("deltaR1", htitle, nbins, xmin, xmax)
  h_deltaR1.SetTitle("deltaR1;deltaR1;events")
  ...
  htitle = "deltaR2"
  nbins, xmin, xmax = 40, 0, 5
  h_deltaR2 = R.TH1F("deltaR2", htitle, nbins, xmin, xmax)
  h_deltaR2.SetTitle("deltaR2;deltaR2;events")
  ...
  htitle = "MindeltaR"
  nbins, xmin, xmax = 40, 0, 5
  h_MindeltaR = R.TH1F("MindeltaR", htitle, nbins, xmin, xmax)
  h_MindeltaR.SetTitle("MindeltaR;MindeltaR;events")
  ...
  h_Y1 = R.TH1F("Y1", htitle, nbins, xmin, xmax)
  h_Y1.SetTitle("Y1;Y1;events")
  ...
  htitle = "Y2"
  nbins, xmin, xmax = 40, -3, 3
  h_Y2 = R.TH1F("Y2", htitle, nbins, xmin, xmax)
  h_Y2.SetTitle("Y2;Y2;events")
  ...
  h_deltaY = R.TH1F("deltaY", htitle, nbins, xmin, xmax)
  h_deltaY.SetTitle("deltaY;deltaY;events")
  ...
  h_Weight = R.TH1F("Weight", htitle, nbins, xmin, xmax)
  h_Weight.SetTitle("Weight;Weight;events")
  ...
  htitle = "Weight1"
  nbins, xmin, xmax = 40, 0, 0.1
  h_Weight1 = R.TH1F("Weight1", htitle, nbins, xmin, xmax)
  h_Weight1.SetTitle("Weight1;Weight1;events")
  ...
  InclusiveTree.Branch("deltaR1", deltaR1, "deltaR1/D")
  InclusiveTree.Branch("deltaR2", deltaR2, "deltaR2/D")
  InclusiveTree.Branch("MindeltaR", MindeltaR, "MindeltaR/D")
  InclusiveTree.Branch("Y1", Y1, "Y1/D")
  InclusiveTree.Branch("Y2", Y2, "Y2/D")
  InclusiveTree.Branch("deltaY", deltaY, "deltaY/D")
  InclusiveTree.Branch("Weight", Weight, "Weight/D")
  InclusiveTree.Branch("Weight1", Weight1, "Weight1/D")
  ...
  TTTree.Branch("deltaR1", deltaR1, "deltaR1/D")
  TTTree.Branch("deltaR2", deltaR2, "deltaR2/D")
  TTTree.Branch("MindeltaR", MindeltaR, "MindeltaR/D")
  TTTree.Branch("Y1", Y1, "Y1/D")
  TTTree.Branch("Y2", Y2, "Y2/D")
  TTTree.Branch("deltaY", deltaY, "deltaY/D")
  TTTree.Branch("Weight", Weight, "Weight/D")
  TTTree.Branch("Weight1", Weight1, "Weight1/D")
  ...
  TLTree.Branch("deltaR1", deltaR1, "deltaR1/D")
  TLTree.Branch("deltaR2", deltaR2, "deltaR2/D")
  TLTree.Branch("MindeltaR", MindeltaR, "MindeltaR/D")
  TLTree.Branch("Y1", Y1, "Y1/D")
  TLTree.Branch("Y2", Y2, "Y2/D")
  TLTree.Branch("deltaY", deltaY, "deltaY/D")
  TLTree.Branch("Weight", Weight, "Weight/D")
  TLTree.Branch("Weight1", Weight1, "Weight1/D")
  ...
  LLTree.Branch("deltaR1", deltaR1, "deltaR1/D")
  LLTree.Branch("deltaR2", deltaR2, "deltaR2/D")
  LLTree.Branch("MindeltaR", MindeltaR, "MindeltaR/D")
  LLTree.Branch("Y1", Y1, "Y1/D")
  LLTree.Branch("Y2", Y2, "Y2/D")
  LLTree.Branch("deltaY", deltaY, "deltaY/D")
  LLTree.Branch("Weight", Weight, "Weight/D")
  LLTree.Branch("Weight1", Weight1, "Weight1/D")
  ...
  TTTLTree.Branch("deltaR1", deltaR1, "deltaR1/D")
  TTTLTree.Branch("deltaR2", deltaR2, "deltaR2/D")
  TTTLTree.Branch("MindeltaR", MindeltaR, "MindeltaR/D")
  TTTLTree.Branch("Y1", Y1, "Y1/D")
  TTTLTree.Branch("Y2", Y2, "Y2/D")
  TTTLTree.Branch("deltaY", deltaY, "deltaY/D")
  TTTLTree.Branch("Weight", Weight, "Weight/D")
  TTTLTree.Branch("Weight1", Weight1, "Weight1/D")
  ...
  for InputFile in InputFileList:
      ...
      for event in lhe:
          ...
          if InputFile == InputFile_Inclusive:
              h_Weight.Fill(Weight[0])
              Weight1[0] = Weight[0]*0.02419*139*1000/WeightSum
              h_Weight1.Fill(Weight1[0])
          elif InputFile == InputFile_TT:
          ...
          if InputFile == InputFile_Inclusive:
              h_deltaR1.Fill(deltaR1[0])
              h_deltaR2.Fill(deltaR2[0])
              h_MindeltaR.Fill(MindeltaR[0])
          elif InputFile == InputFile_TT:
          ...
          # loop the deltamSorts, find "0", which represents the closest Z mass
          for i, deltamSort in enumerate(deltamSorts):
              # choose the Zmass which is closest to the real Zmass, fill its eta in the h_Y1
              if i == 0:
  ...
  tfout = R.TFile("KinematicQuantity_v5.root", "RECREATE")
  tfout.cd()
