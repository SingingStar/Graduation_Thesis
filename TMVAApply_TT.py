...
def TMVAApply(InputFile):
  ...
  InputFile = R.TFile.Open("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v4_Output/TTTree.root")

  data = InputFile.Get("TTTree")
  ...
  h_TT = R.TH1F("h_TT", "h_TT", 40, -1, 1)
  for i in range(0, data.GetEntries()):
      data.GetEntry(i)
      h_TT.Fill(reader.EvaluateMVA("BDT Method"))

  tfout = R.TFile("h_TT.root", "RECREATE")
  tfout.cd()
...
if __name__ == "__main__":
  ...
  InputFile = R.TFile("/users/wuxingyu/Desktop/WorkingSpace/KinematicQuantity_v5_Output/TTTree.root")
