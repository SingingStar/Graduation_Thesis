...
def read_lhe(input_fileList):
  ...
  Accuracy = CorrectPair/SumPair
  print("Accuracy", '%.2f%%' % (Accuracy * 100))

  # creat a ROOT file to histogram
  tfout = R.TFile("CosTheta_v2.root", "RECREATE")
  tfout.cd()
  h_M1.Write()
  h_M2.Write()
  h_M1MOTHUP.Write()
...
if __name__ == "__main__":
  ...
  input_file1 = "/users/wuxingyu/DownLoads/1unweighted_events.lhe.gz"
  input_file2 = "/users/wuxingyu/DownLoads/2unweighted_events.lhe.gz"
  input_file3 = "/users/wuxingyu/DownLoads/3unweighted_events.lhe.gz"
  input_file4 = "/users/wuxingyu/DownLoads/4unweighted_events.lhe.gz"
  input_file5 = "/users/wuxingyu/DownLoads/5unweighted_events.lhe.gz"
  input_file6 = "/users/wuxingyu/DownLoads/6unweighted_events.lhe.gz"
  input_file7 = "/users/wuxingyu/DownLoads/7unweighted_events.lhe.gz"
  input_file8 = "/users/wuxingyu/DownLoads/8unweighted_events.lhe.gz"
  input_file9 = "/users/wuxingyu/DownLoads/9unweighted_events.lhe.gz"
  input_file10 = "/users/wuxingyu/DownLoads/10unweighted_events.lhe.gz"
  input_fileList = [input_file1, input_file2, input_file3, input_file4, input_file5, input_file6, input_file7, input_file8, input_file9, input_file10]

  read_lhe(input_fileList=input_fileList)
